	...
	return (
		<>
			<article
				...
				<section
					className='inicio-hero-image-opacity'
				...
				<section className='inicio-hero-image-opacity text-left text-lg-center'>
					<div className='columnas container section'>
						...
						<div className='columna'>
							<p>
								...
								orientado al <i>Backend</i>, pero también hago{' '}
								<i>Frontend</i>. Me gusta enfrentar nuevos
