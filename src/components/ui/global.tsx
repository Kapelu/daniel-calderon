...
export default function TextSphere({
  word = 'El código más citado para replicar el efecto de la "lluvia digital" es #00FF41 (conocido como Erin).  Este tono brillante se utiliza comúnmente para la cabeza de las letras en caída, mientras que el resto de la estela utiliza variaciones más oscuras o desvanecidas. Otra referencia muy común es #03A062, etiquetada específicamente como "Matrix Green" en guías de colores, la cual es ligeramente menos saturada y más parecida al tinte general de las escenas dentro de la Matrix. \n\n',
  color = '#73986D',
  font = {
    fontFamily: 'Inter',
    variant: 'Regular',
